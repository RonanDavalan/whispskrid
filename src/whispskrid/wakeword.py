...
# aucun rapport avec le contenu réel des modèles ONNX (leur entraînement —
# voir docstring de module — n'est pas couvert ici).
...
def unload() -> None:
    """Libère l'état chargé — appelé au désarmement (aucune dépendance à
